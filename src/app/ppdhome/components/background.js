  ...
  return (
    <div className="fixed inset-0 -z-10 bg-white">
      ...
      <div
        ...
        style={{
          background: `
            radial-gradient(circle at 50% 15%, #f9bed5ab 0%, rgba(255,255,255,0) 25%),
            radial-gradient(circle at 20% 40%, rgba(226, 70, 153, 0.38) 0%, rgba(255,160,210,0) 15%),
            radial-gradient(circle at 50% 80%, #f393b8bd 0%, rgba(255,205,230,0) 25%)
          `,
        }}
      />
      ...
      <div
        ...
        style={{
          background: `
            ...
            radial-gradient(circle at 90% 16%, rgba(226,70,153,0.64) 0%, rgba(255,193,221,0) 23%),
            radial-gradient(circle at 16% 90%, rgba(226,70,153,0.64) 0%, rgba(255,160,210,0) 20%),
