    ...
    return (
        <div className="flex bg-white justify-center lg:mx-20 md:mx-9 mx-4 lg:my-10 my-4 md:py-10 py-4 rounded-xl text-black shadow-lg">
            <div className="flex flex-col">
                <p className="text-center xl:text-5xl md:text-3xl text-xl text-shadow-lg">โครงสร้างผู้บริหาร</p>
            <div className="flex flex-col items-center lg:mt-10 mt-4">
                ...
                <p className="xl:text-3xl md:text-2xl text-lg md:mt-4 mt-2 text-shadow-lg">ว่าที่ร้อยตรีณัทกร ธงสอาด</p>
            ...
            <div className="flex justify-between lg:gap-14 md:gap-6 lg:mt-10 md:mt-6 mt-4 lg:mx-0 mx-4">
                ...
                <p className="xl:text-3xl md:text-lg text-xl mt-4 text-shadow-lg">สุภาพร ประทุมสังข์</p>
            ...
            <div className="flex flex-col items-center">
                ...
                <p className="xl:text-3xl md:text-lg text-xl mt-4 text-shadow-lg">วัชรพัฒน์ หน่อเพ็ชร</p>
            ...
            <div className="flex flex-col items-center">
                ...
                <p className="xl:text-3xl md:text-lg text-xl mt-4 text-shadow-lg">ธนกร สุขรมย์</p>
            ...
            <div className="flex flex-col items-center">
                <Image src={getSupabaseImage("pic/watcharapan.jpg")} alt="รูปผู้ปกครอง" width={250} height={100} className="rounded-xl"></Image>
                <p className="xl:text-3xl md:text-lg text-xl mt-4 text-shadow-lg">วัชรพัฒน์ หน่อเพ็ชร์</p>
                <p className="mt-2 lg:text-base text-sm text-center">นักพัฒนาสังคมปฎิบัติการ</p>
