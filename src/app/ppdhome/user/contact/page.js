...
export default function Contact() {
    return (
        <section className="bg-pink-100 text-black">
            <div className="lg:p-10 md:p-6 p-4 flex lg:justify-between lg:flex-row flex-col">
                ...
                <div className="w-3/4">
                    <MotionWrapper>
                        <Image
                            ...
                            width={1500}
                            height={200}
                            className="h-auto lg:h-140 object-cover w-full rounded-xl"
                        />
                    </MotionWrapper>
                </div>
...
<MotionWrapper>
                        <div className="flex flex-row gap-4 mt-4">
                                ...
                                <p className="flex gap-2 lg:text-2xl md:text-xl font-semibold mt-4">
                                    <svg className="md:w-[35px] md:h-[35px] w-[25px] h-[25px] md:-mt-2 -mt-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="none" viewBox="0 0 24 24">
                                        <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 13a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z" />
                                        <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17.8 13.938h-.011a7 7 0 1 0-11.464.144h-.016l.14.171c.1.127.2.251.3.371L12 21l5.13-6.248c.194-.209.374-.429.54-.659l.13-.155Z" />
                                    </svg>
                                </p>
                                <div className="flex flex-col">
                                    <p className="lg:text-lg md:text-base text-sm font-light mt-3">
...
<MotionWrapper>
                        <div className="flex flex-row gap-4 mt-4">
                                ...
                                <p className="flex gap-2 lg:text-2xl md:text-xl text-lg font-semibold ">
                                    <svg className="md:w-[35px] md:h-[35px] w-[25px] h-[25px] md:-mt-2 -mt-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                        ...
                        <div className="hidden md:block mt-4">
                            <MotionWrapper>
                                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3876.9239755571425!2d100.53514097549534!3d13.662386599356589!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x30e2a189249a8719%3A0xdd7766e0f030a9d!2z4Liq4LiW4Liy4LiZ4LiE4Li44LmJ4Lih4LiE4Lij4Lit4LiH4LmB4Lil4Liw4Lie4Lix4LiS4LiZ4Liy4LiE4LiZ4Lie4Li04LiB4Liy4Lij4Lie4Lij4Liw4Lib4Lij4Liw4LmB4LiU4LiH!5e0!3m2!1sth!2sth!4v1766567829947!5m2!1sth!2sth"
                                    width="500" height="400" style={{ border: 0 }} allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade" className="rounded-xl w-[400px] h-[200px] md:ms-4 ms-10 md:mt-8 lg:ms-0 lg:mt-0"></iframe>
                            </MotionWrapper>
                        </div>
                        <MotionWrapper>
                            <div className="lg:mt-4 md:mt-4 mt-3 flex flex-row gap-4">
                                ...
                                <a href={"https://www.tiktok.com/@._dep3?_t=ZS-8upw3waHByR&_r=1"} className="flex md:mt-6 mt-5 ms-2">
