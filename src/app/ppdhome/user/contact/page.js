                ...
                <div className="flex md:justify-between md:flex-row flex-col lg:mt-10 md:mt-6 lg:mx-15 md:mx-10 md:mx-6 mx-2">
                    <div>
                        <p className="flex gap-2 lg:text-2xl md:text-xl text-lg font-semibold mt-4">
                            <svg className="md:w-[40px] md:h-[40px] w-[30px] h-[30px] md:-mt-3 -mt-1 text-pink-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="none" viewBox="0 0 24 24">
                        ...
                        <p className="flex gap-2 lg:text-2xl md:text-xl text-lg font-semibold lg:mt-10 mt-4">
                            <svg className="md:w-[40px] md:h-[40px] w-[30px] h-[30px] md:-mt-2 -mt-1 text-pink-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                        ...
                        <p className="lg:text-xl md:text-base text-sm font-light mt-3">
                            โทรศัพท์: 0-2462-5232
                        </p>

                        <p className="flex gap-2 lg:text-2xl md:text-xl text-lg font-semibold lg:mt-10 md:mt-4 mt-3">
                            <svg className="md:w-[40px] md:h-[40px] w-[30px] h-[30px] md:-mt-2 -mt-1 text-pink-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                        ...
                        <div className="lg:mt-10 md:mt-4 mt-3">
                    ...
                    <div className="hidden md:block">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3876.9239755571425!2d100.53514097549534!3d13.662386599356589!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x30e2a189249a8719%3A0xdd7766e0f030a9d!2z4Liq4LiW4Liy4LiZ4LiE4Li44LmJ4Lih4LiE4Lij4Lit4LiH4LmB4Lil4Liw4Lie4Lix4LiS4LiZ4Liy4LiE4LiZ4Lie4Li04LiB4Liy4Lij4Lie4Lij4Liw4Lib4Lij4Liw4LmB4LiU4LiH!5e0!3m2!1sth!2sth!4v1766567829947!5m2!1sth!2sth"
                            width="500" height="400" style={{ border: 0 }} allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade" className="rounded-xl lg:w-[500px] lg:h-[400px] w-[300px] h-[300px] md:ms-10 md:mt-8 lg:ms-0 lg:mt-0"></iframe>
                    </div>
